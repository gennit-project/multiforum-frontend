  ...
  setup() {
    ...
    const {
      ...
      update: (cache: any, result: any) => {
        const newChannel: ChannelData = result.data?.createChannels?.channels[0]
            ...
            channels(existingChannelRefs = [], fieldInfo: any) {
              ...
              if (
                existingChannelRefs.some(
                  (ref: any) => readField("uniqueName", ref) === newChannel.uniqueName
                )
              ) {
        ...
        <div>
          ...
          <div class="mt-6 sm:mt-5 space-y-6 sm:space-y-5">
            ...
            <FormRow :section-title="'Description'">
              <TextEditor class="mb-3" :value="description" @update="updateDescription" />
            </FormRow>
