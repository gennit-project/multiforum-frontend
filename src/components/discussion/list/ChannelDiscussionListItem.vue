...
<template>
  <li
    class="relative mt-1 flex space-y-3 border-b border-gray-200 py-4 dark:border-gray-400 lg:py-4"
  >
    <v-row>
      <v-col :cols="2">
        <DiscussionVotes
      ...
      <v-col :cols="10">
        ...
        >
          ...
          <div
            v-if="truncatedBody"
            class="my-2 border-l-2 border-gray-400 dark:bg-gray-700 max-w-lg"
          >
