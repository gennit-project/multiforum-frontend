...
<template>
  <div v-if="showDropdown">
    ...
    <div
      ...
      class="fixed left-0 top-0 z-50 flex h-full w-[250px] flex-col justify-between overflow-y-auto border-gray-300 bg-white py-2 dark:border-gray-700 dark:bg-gray-900"
    >
      <div>
