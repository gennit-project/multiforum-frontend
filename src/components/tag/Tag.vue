...
<template>
  <span
    ...
    :class="[
      ...
      !this.active && !channelMode ? 'text-slate-600 bg-gray-100 dark:bg-opacity-700 dark:bg-slate-700 dark:text-slate-300 hover:bg-slate-300 dark:hover:bg-slate-600' : '',
