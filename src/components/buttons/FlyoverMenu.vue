  ...
  <Popover class="relative inline-flex" v-slot="{ open }">
    <PopoverButton
      :class="[
        ...
        'mb-1 inline-flex justify-center w-full rounded-md px-3 py-2 bg-white text-xs font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500',
      ]"
    >
      <span>{{ name }}</span>
